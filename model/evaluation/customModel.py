...
def train(model, target_model, replay_buffer, optimizer, criterion, batch_size=64, gamma=0.99):
    model.train()
    target_model.eval()
    total_loss = 0
    ...
    return model, total_loss # Note: since pytorch models are mutable, no need to actually return model
